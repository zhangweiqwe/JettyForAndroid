        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(v.getContext())
                        .setTitle(R.string.sqlite_manager_delete)
                        .setNegativeButton(R.string.sqlite_manager_cancel, null)
                        .setPositiveButton(R.string.sqlite_manager_delete, new DialogInterface.OnClickListener() {
                            @Override
